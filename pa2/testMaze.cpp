...
TEST_CASE("treasureMap::basic no cycles", "[weight=1][part=treasureMap]")
{
	...
	treasuremaze.writeToFile("images/test2.png");
    PNG treasuremazeans;
   ...
   // soln.writeToFile("images/solnsnake.png");
    soln.writeToFile("images/test3.png");
    PNG mazeOverlay = dec.renderMaze();
    mazeOverlay.writeToFile("images/overlayedIMG.png");
    PNG solnans;
   ...
   // solnmaze.writeToFile("images/solnsnakemaze.png");
    solnmaze.writeToFile("images/test4.png");
    PNG solnmazeans;
